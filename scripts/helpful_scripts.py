...
contract_to_mock = {
    ...
    "oracle": MockOracle,
    "keeper_registry": MockKeeperRegistry,
}
...
def deploy_mocks(decimals=DECIMALS, initial_value=INITIAL_VALUE):
    ...
    print("Deploying Mock Keeper Registry...")
    mock_keeper_registry = MockKeeperRegistry.deploy(link_token.address, {"from": account})
    print(f"Deployed to {mock_keeper_registry.address}")
